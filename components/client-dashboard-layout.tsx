...
import { Droplets, LayoutDashboard, Gauge, Bell, Settings, BarChart3, LogOut, Menu } from "lucide-react"
...
export function ClientDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/dashboard/water-control", icon: <Gauge size={20} />, label: "Water Control" },
    { href: "/dashboard/reports", icon: <BarChart3 size={20} />, label: "Reports" },
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Link href="/dashboard" className="flex items-center gap-2">
              <Droplets className="h-6 w-6 text-cyan-600" />
              <span className="text-lg font-bold hidden md:inline">Client Dashboard</span>
            </Link>
          </div>
